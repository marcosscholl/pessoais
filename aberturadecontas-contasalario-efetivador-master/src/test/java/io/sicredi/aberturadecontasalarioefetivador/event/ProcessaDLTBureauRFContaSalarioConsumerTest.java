...
class ProcessaDLTBureauRFContaSalarioConsumerTest {
    ...
    @InjectMocks
    ProcessaDLTBureauRFContaSalarioConsumer consumer;
    ...
    void deveProcessarEventoComSucesso(){
        ...
        verify(dltEventService, times(1)).processarErroSolicitacaoBureauRF(any());
    ...
    void naoDeveProcessarEventoComConflitoDeTransactionId(){
        ...
        when(dltEventService.processarErroSolicitacaoBureauRF(any())).thenThrow(IdempotentTransactionDuplicatedException.class);
