...
class ProcessaCadastroContaSalarioConsumerTest {
    ...
    @InjectMocks
    ProcessaCadastroContaSalarioConsumer consumer;
    ...
    void deveProcessarEventoComSucesso() {
        ...
        verify(contaSalarioService, times(1)).processarSolicitacaoUnitaria(any());
    ...
    void naoDeveProcessarEventoComConflitoDeTransactionId() {
        ...
        when(contaSalarioService.processarSolicitacaoUnitaria(any())).thenThrow(IdempotentTransactionDuplicatedException.class);

        Assertions.assertThrows(IdempotentTransactionDuplicatedException.class, () -> consumer.accept(message));
